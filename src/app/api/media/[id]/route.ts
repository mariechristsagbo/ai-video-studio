  ...
  try {
    ...
    if (url.searchParams.has("download"))
      headers["Content-Disposition"] =
        `attachment; filename="studio-${id}.${asset.mime === "video/mp4" ? "mp4" : asset.mime === "image/jpeg" ? "jpg" : "media"}"`;
    return new Response(
